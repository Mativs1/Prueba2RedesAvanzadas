...
def leer_documento_txt():
    clear_screen()
    nombre_archivo = 'oficinaR3-4.txt'
...
def menu():
    clear_screen()
    print("--------------MENU-------------------")
    print("1. leer archivo oficinaR3-4.txt")
    print("2. Agregar al archivo oficinaR3-4.txt")
    print("3. Reemplazar Texto en archivo oficinaR3-4.txt")
    print("4. Salir.")
    print("\n\n---------------------------------")
